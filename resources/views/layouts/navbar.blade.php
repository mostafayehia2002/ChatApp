<nav class="navbar navbar-expand-lg"
    style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border-bottom: 1px solid #e5e7eb; box-shadow: 0 4px 15px rgba(0,0,0,0.08); padding: 0.75rem 0;">
    <div class="container-fluid d-flex align-items-center justify-content-between px-4">
        <div class="d-flex align-items-center gap-3">
            <button class="btn btn-link p-0" id="sidebarToggle"
                style="border: none; color: #667eea; font-size: 20px; transition: all 0.3s;">
                <i class="fas fa-bars"></i>
            </button>
            <a class="navbar-brand fw-700 m-0 d-flex align-items-center gap-2" href="{{ route('home') }}"
                style="font-size: 22px; letter-spacing: -0.5px;">
                <i class="fas fa-comments" style="color: #667eea; font-size: 24px;"></i>
                <span
                    style="background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">EchoChat</span>
            </a>
        </div>
            ...
            @auth
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown"
                        ...
                        style="gap: 12px; text-decoration: none; color: #1f2937;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown"
                        ...
                        <li style="padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
                            <div class="px-4 d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div style="font-weight: 600; font-size: 14px; color: #1f2937;">{{ $user->name }}
                                    </div>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('profile.edit') }}"
                                ...
                                <i class="fas fa-user-circle me-3"
                                    style="font-size: 16px; color: #667eea; width: 20px;"></i>
                                My Profile
                            </a>
                        </li>
