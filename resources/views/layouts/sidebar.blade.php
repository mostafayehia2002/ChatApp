<!-- Sidebar: Contacts -->
<div id="sidebar" class="border-end p-0 sidebar-container" style="height: 90vh; overflow-y: auto; font-size: 14px;">
    ...
    <div class="bg-white p-2 px-3 d-flex justify-content-between align-items-center border-bottom">
        ...
        <button class="btn btn-sm btn-outline-primary d-flex align-items-center justify-content-center"
            data-bs-toggle="modal" data-bs-target="#addContactModal" style="width: 34px; height: 34px;">
    ...
    <div class="px-3 pt-3 pb-2">
        <div class="position-relative">
            <input type="text" id="contactsSearchInput" value="{{ request('search') }}"
                class="form-control form-control-sm rounded-pill ps-4" placeholder="Search...">
    ...
    <div id="conversions">
        @forelse($conversations as $conversation)
            <a href="{{ route('conversation.show', ['conversationId' => $conversation['id']]) }}"
                class="text-decoration-none text-dark" data-id="1">
                <div class="p-2 px-3 border-bottom d-flex align-items-center">
                    <!-- avatar -->
                    <img src="{{ $conversation['image'] }}" class="rounded-circle me-2"
