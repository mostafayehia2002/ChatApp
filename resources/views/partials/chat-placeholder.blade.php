<div id="noChatPlaceholder" class="d-flex flex-column justify-content-center align-items-center p-0 w-100"
    ...
    <div
        style="position: absolute; top: -100px; right: -100px; width: 300px; height: 300px; background: radial-gradient(circle, rgba(102, 126, 234, 0.1), transparent); border-radius: 50%;">
    </div>
    <div
        style="position: absolute; bottom: -50px; left: -50px; width: 250px; height: 250px; background: radial-gradient(circle, rgba(118, 75, 162, 0.08), transparent); border-radius: 50%;">
    </div>
    ...
    <div style="position: relative; z-index: 10; text-align: center;">
        <div style="margin-bottom: 24px;">
            <i class="fas fa-comments"
                style="font-size: 64px; background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"></i>
        </div>
